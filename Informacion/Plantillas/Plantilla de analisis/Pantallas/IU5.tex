...
\begin{itemize}
	\item \IUbutton{Enviar}: Se habilita una vez que la caja de texto tenga contenido. Si tiene contenido se envia y se muestra el comentario debajo de la información del componente.
\end{itemize}
