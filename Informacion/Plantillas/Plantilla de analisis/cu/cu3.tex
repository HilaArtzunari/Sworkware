...
%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	\begin{UseCase}{CU3}{Agregar componente}{
		...
		\UCitem{Entradas}{El usuario podr\'a insertar nombre, modelo, identificador, unidad de aprendizaje, escuela del producto a ofertar el cual ser\'a caracteristico por ser una cadena de caracteres alfanumericos con tama\~no m\'aximo de 70 caracteres.}
